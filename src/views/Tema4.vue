  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderF.mb-5(columnas="col-lg-3 col-md-6")
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          ...
          h4.text-center.mb-3 Beneficio
          p.text-center Identificación de la rentabilidad obtenida por la empresa.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-5
              img(src='@/assets/curso/temas/t4/ico2.svg' alt='')
          h4.text-center.mb-3 Dinero en efectivo
          p.text-center Disponibilidad de liquidez para hacer frente a las obligaciones inmediatas.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-5
              img(src='@/assets/curso/temas/t4/ico3.svg' alt='')
          h4.text-center.mb-3 Obligaciones de pago
          p.text-center Conocimiento detallado de los compromisos financieros que debe cubrir la empresa.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-6
              img(src='@/assets/curso/temas/t4/ico4.svg' alt='')
          h4.text-center.mb-3 Activo inmediatamente realizable
          p.text-center Bienes que pueden convertirse en efectivo en el corto plazo.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-5
              img(src='@/assets/curso/temas/t4/ico5.svg' alt='')
          h4.text-center.mb-3 Capital inmovilizado
          p.text-center Recursos que no se pueden disponer rápidamente, como activos fijos.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-5
              img(src='@/assets/curso/temas/t4/ico6.svg' alt='')
          h4.text-center.mb-3 Relación entre capital propio y ajeno
          p.text-center Análisis del equilibrio entre financiamiento propio y externo.
      .tarjeta.tarj-slider.p-4.py-5
        .align-items-center
          .row.justify-content-center.my-3
            .col-5
              img(src='@/assets/curso/temas/t4/ico7.svg' alt='')
          h4.text-center.mb-3 Porcentaje de rendimiento de la inversión
          p.text-center Evaluación de la eficacia de las inversiones realizadas.  
    ...
    .row.align-items-center.mb-5
      .col-lg-7(data-aos="fade-right")
        LineaTiempoD.color-primario
          p(numero="1" titulo="Provisión de recursos financieros") Garantiza los medios necesarios para cubrir las obligaciones de pago de la empresa, manteniendo la solvencia y liquidez.
          p(numero="2" titulo="Obtención de beneficios") Se encarga de invertir el efectivo en operaciones que generen un valor actual atractivo para la organización. 
      .col-lg-5.d-none.d-lg-block(data-aos="fade-left")
        img(src='@/assets/curso/temas/t4/img2.png', alt='')
    
    p El objetivo central de la administración financiera es incrementar el valor actual de la riqueza de la empresa. Esto se logra asegurando que siempre haya suficiente efectivo para cubrir las cuentas en el momento adecuado y optimizando la distribución de los recursos disponibles.
    p En el proceso de creación de empresas, se han identificado ciertos paradigmas erróneos en relación con los aspectos financieros. Estos mitos, que son repetidos sin cuestionamiento, pueden generar temores en los emprendedores y disuadirlos de seguir adelante con sus proyectos. Es común que estos falsos paradigmas lleven a una dependencia exclusiva en la parte financiera, ignorando otros factores clave para el éxito. Por lo tanto, es crucial que los emprendedores analicen y desmitifiquen estas creencias para no limitar el desarrollo de sus empresas, dado que dichos paradigmas no representan una realidad concreta y pueden obstaculizar el crecimiento.
    ...
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          ...
          h4.text-center Balance general
          p.text-center.mb-0 Refleja la situación patrimonial, incluyendo activos y pasivos.
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          .row.justify-content-center.mb-3
            .col-5.img-deco
          ...
          p.text-center.mb-0 Muestra las ganancias o pérdidas del negocio.
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          .row.justify-content-center.mb-3
            .col-5.img-deco
              img(src='@/assets/curso/temas/t4/boton3.png', alt='')
          h4.text-center Flujo de efectivo
          p.text-center.mb-0 Presenta los ingresos y egresos de dinero, crucial para mantener la liquidez.  
    ...
    .bloque-texto-g.bloque-texto-g--inverso.color-secundario.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4
        p El horizonte temporal de estas proyecciones puede variar según la naturaleza de cada empresa, generalmente de 3 a 5 años, aunque algunas optan por un plazo de hasta 10 años, que es menos común. Para mejorar la precisión, se recomienda que el primer año de proyección se realice con un detalle mensual.
        br
        br
    ...
    .row.align-items-center.subt.mb-4(data-aos="fade-left")
      ...
      .col-10.col-md-auto.ps-0
        h3.mb-0 El control presupuestal en la dirección financiera
          ...
          SlyderA.t4.p-4.px-5
            .tarjeta.tarjeta--blanca.p-4
              .row.align-items-center.justify-content-center
                .col-lg-2.col-md-2.col-5.mb-3.mb-md-0
                  img(src='@/assets/curso/temas/t4/slyder1.svg', alt='')
                .col-lg-10.col-md-10
                  p.mb-0 Este proceso fomenta una visión más estratégica, e impulsa a los responsables a cuestionarse sobre las acciones que omitirían si no tuvieran la obligación de preparar un presupuesto. 
            .tarjeta.tarjeta--blanca.p-4
              .row.align-items-center.justify-content-center
                .col-lg-2.col-md-2.col-5.mb-3.mb-md-0
            ...
            .tarjeta.tarjeta--blanca.p-4 
              .row.align-items-center.justify-content-center
                ...
                .col-lg-10.col-md-10
                  p.mb-0 Una vez que los presupuestos se han formalizado, el siguiente paso es la elaboración de los estados contables. Estos documentos se desarrollan a partir de los estados financieros de cierre de un ejercicio anterior, complementados con la síntesis de todos los presupuestos de las diferentes áreas de la empresa. 
            .tarjeta.tarjeta--blanca.p-4
              .row.align-items-center.justify-content-center
                .col-lg-2.col-md-2.col-5.mb-3.mb-md-0
                  img(src='@/assets/curso/temas/t4/slyder4.svg', alt='')
                .col-lg-10.col-md-10
                  p.mb-0 Con esta información, es posible proyectar los resultados operativos, las cuentas de pérdidas y ganancias, y el balance general que la empresa espera presentar al final del ejercicio presupuestado.  
    ...
    .row.justify-content-center.mb-4(data-aos="fade-down")
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          ...
          p.text-center.mb-0 La diferencia entre la rentabilidad de los activos de la empresa y el costo de financiamiento o capital necesario para adquirir dichos activos.       
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          .row.justify-content-center.mb-3
            .col-5.img-deco
              img(src='@/assets/curso/temas/t4/boton5.png', alt='')
          p.text-center.mb-0 Este concepto es clave en la cultura de la gerencia del valor, un enfoque que impulsa a los tomadores de decisiones a desarrollar estrategias orientadas a la creación de valor.       
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-acento-contenido.p-4.h-100.bg3.t3
          .row.justify-content-center.mb-3
            .col-5.img-deco
              img(src='@/assets/curso/temas/t4/boton6.png', alt='')
          p.text-center.mb-0 En esencia, se espera que los recursos de la empresa generen una rentabilidad superior a su costo; de lo contrario, sería más eficiente redirigir esos recursos a otras actividades más productivas. 
    
    .bloque-texto-g.bloque-texto-g--inverso.color-secundario.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/t4/img6.png')})`}")
      .bloque-texto-g__texto.p-4
        p Las empresas que solo se enfocan en indicadores tradicionales, como la utilidad neta, los márgenes de ganancia o el crecimiento en ventas, corren el riesgo de desarrollar una visión limitada. Este enfoque puede pasar por alto elementos cruciales como la optimización del capital de trabajo o la productividad derivada del uso eficiente de la capacidad instalada. La verdadera evaluación de oportunidades empresariales se basa en indicadores enfocados en la creación de valor, más allá de los beneficios inmediatos.
        br
        br
    ...
    .row.justify-content-center.mb-4(data-aos="fade-down")  
      .col-md-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta-numerada.color-primario.p-5.px-lg-3.h-100
          .tarjeta-numerada__numero
            .h2 1
          h4.text-center Utilidades
          p.text-center.mb-0 Los beneficios obtenidos tras descontar los costos operativos y financieros.
      .col-md-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta-numerada.color-secundario.p-5.px-lg-3.h-100
          .tarjeta-numerada__numero
            .h2 2
          h4.text-center Rentabilidad
          p.text-center.mb-0  La capacidad de generar ingresos en relación con los activos utilizados.
      .col-md-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta-numerada.color-acento-botones.p-5.px-lg-3.h-100
          .tarjeta-numerada__numero
            .h2 3
          h4.text-center Flujo de caja libre
          p.text-center.mb-0 La disponibilidad de efectivo para inversiones y operaciones, sin comprometer recursos en actividades improductivas. 
